...
import java.util.regex.Matcher;//used for:isValidEmail
import java.util.regex.Pattern;//used for:isValidEmail

public class Theater {

    private Ticket[] row1 = new Ticket[12];  ///task1
    ...
    private void buy_ticket() {          ////task3 & task12
    ...
    private void print_seating_area() {        ////task4
    ...
    private void cancel_ticket() {                 ///task5 & task 12
    ...
    private void show_available() {           ///task6
    ...
    private void show_tickets_info() {           ///task13
    ...
    private void sort_tickets() {                    ///task14
        ...
        Ticket[] allRowArray = new Ticket[count_1];
        ...
        for(int i=0;i<allRowArray.length;i++) {
            for (Ticket ticket : row1) {
                if (ticket != null) {
                    double a = allRowArray[i].getPrice();
                    x1 = x1+ a;
                }
            }
        }
        ...
        System.out.println("total price:"+(total/count_1));
